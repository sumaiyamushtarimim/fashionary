...
const WhatsAppIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg viewBox="0 0 24 24" {...props}>
      <path
        fill="currentColor"
        d="M12.04 2C6.58 2 2.13 6.45 2.13 12c0 1.78.46 3.45 1.28 4.91L2 22l5.25-1.38c1.39.75 2.96 1.18 4.59 1.18h.02c5.46 0 9.91-4.45 9.91-9.91 0-5.46-4.45-9.91-9.91-9.91z"
      />
      <path
        fill="#FFF"
        d="M17.43 15.6c-.22-.11-1.3-.64-1.5-.72s-.35-.11-.5.11c-.15.22-.57.72-.7 1.07-.13.35-.26.4-.48.35-.22-.05-1.07-.39-2.04-1.26-.75-.67-1.26-1.5-1.41-1.76-.15-.26-.02-.4 0-.51s.22-.26.33-.39c.11-.13.15-.22.22-.38.07-.15.04-.26-.02-.38-.05-.11-.5-1.2-.68-1.64-.18-.43-.37-.38-.5-.38h-.4c-.15 0-.38.05-.57.26-.18.22-.7.68-.7 1.66s.72 1.93.82 2.08c.1.15 1.41 2.16 3.4 3.01.47.2 1.05.33 1.4.43.5.13 1.04.11 1.43.07.45-.05 1.3-.53 1.48-1.04.18-.5.18-.93.13-1.04-.05-.11-.18-.18-.4-.28z"
      />
    </svg>
  );
